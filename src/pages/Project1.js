...
const Project1 = () => {
  return (
    ...
    >
      ...
      <a href="https://appliedjobtracker.netlify.app/" target="_blank">
        <button>Live Site</button>
      </a>
      <a href="https://github.com/peterkimm/applied_frontend" target="_blank">
        <button>GitHub</button>
      </a>

      <p>Job application tracker with easy follow-up capabilities</p>
      <p>
        Full CRUD application built with a React JS frontend and Express JS and
        MongoDB backend. Built a mobile-first application for ease of use using
        SASS and CSS, with ability to filter jobs by time applied and are cooler
        coded for recognition. Utilized Google Firebase for login and session
        capabilities.
      </p>
      <p>
